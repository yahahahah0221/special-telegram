				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="mo" items="${myOrder}"> 
						<tr>
							...
							<td bgcolor="#ffffff"  align="center">${mo.amout}</td>
							...
							<c:if test="${mo.status}" >已付款</c:if>
							</td>
							<td align="center" bgcolor="#ffffff">
							<a style="text-decoration: none;" class="f6" href="user/orderDetail?ordersn=${mo.id}" target="_blank">详情</a>
							</td>
						</tr>
					</c:forEach>
				</table>
